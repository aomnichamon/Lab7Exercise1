    ...
    public void buttonClicked(View v) {
        ...
        if (id == R.id.btBangkok) {
            if (lastBtn != R.id.btBangkok && time_end - time_start <= 60000) {
                ...
                Toast t = Toast.makeText(this.getApplicationContext(), "Please wait 1 minute to click Bangkok.", Toast.LENGTH_SHORT);
                t.show();
            }
            ...
            if (lastBtn != R.id.btNon && time_end - time_start <= 60000) {
                ...
                Toast t = Toast.makeText(this.getApplicationContext(), "Please wait 1 minute to click Nonthaburi.", Toast.LENGTH_SHORT);
                t.show();
            }
            ...
            if (lastBtn != R.id.btPathum && time_end - time_start <= 60000) {
                ...
                Toast t = Toast.makeText(this.getApplicationContext(), "Please wait 1 minute to click Pathumthani.", Toast.LENGTH_SHORT);
                t.show();
            }
        }
    }
...
//Start parsing JSON
    ...
    protected void onPostExecute(Boolean result) {
        ...
        if (result) {
            ...
            tvWind.setText(String.format("%.1f", windSpeed)); //tvWind.setText(Long.toString(time_start));
            tvTemp.setText(String.format("%.1f", temp)+ "(max = " +String.format("%.1f",
            tempmax)+", min = " + String.format("%.1f", tempmin) + ")");
